...
CREATE TABLE `produtos_pedido` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_produtos_pedido_numero_pedido` (`numero_pedido`),
  KEY `idx_produtos_pedido_codigo_produto` (`codigo_produto`),
  CONSTRAINT `produtos_pedido_ibfk_1` FOREIGN KEY (`numero_pedido`) REFERENCES `pedidos` (`numero_pedido`),
  CONSTRAINT `produtos_pedido_ibfk_2` FOREIGN KEY (`codigo_produto`) REFERENCES `produtos` (`codigo`)
